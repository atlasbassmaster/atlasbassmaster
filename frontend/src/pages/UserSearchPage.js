...
const s = {
  ...
  headerLogo: { height: "48px", width: "auto", borderRadius: "0" },
  headerTitle: { color: "#1a3a5c", fontWeight: "bold", fontSize: "18px" },
  ...
  logoutBtn: {
    ...
    color: "#1a3a5c", padding: "6px 14px", borderRadius: "20px", cursor: "pointer", fontSize: "13px",
  },
  exportBar: {
